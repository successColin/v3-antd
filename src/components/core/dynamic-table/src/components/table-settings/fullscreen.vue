<script setup lang="ts">
  ...
  const updateAppContainerStyle = () => {
    const appEl: HTMLDivElement = currentInstance?.appContext.app._container || document.querySelector('#app')
...
<template>
  <a-tooltip v-model:open="open" placement="top">
    ...
    <component :is="isFullscreen ? FullscreenExitOutlined : FullscreenOutlined" @click="toggleFullscreen" />
  </a-tooltip>
</template>
