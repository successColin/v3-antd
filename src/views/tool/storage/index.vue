  ...
  <div>
    ...
    >
      <template #toolbar>
        ...
        <a-popconfirm title="你确定要删除这些数据吗?" ok-text="确定" cancel-text="取消" @confirm="handleDelete">
          <a-button :disabled="!$auth('tool:storage:delete') || !checkedKeys.length" type="error"> 删除 </a-button>
        </a-popconfirm>
      </template>
    </DynamicTable>
  </div>
