<template>
  ...
  >
    <template #toolbar>
      <a-button type="primary" :disabled="!$auth('system:dict-type:create')" @click="openMenuModal({})">
        新增
      </a-button>
    </template>
...
<script lang="ts" setup>
  ...
  import { baseColumns, searchFormSchema, dictItemRouteName, type TableListItem, type TableColumnItem } from './columns'
