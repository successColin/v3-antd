<template>
  <div>
    ...
    >
      <template #toolbar>
        <a-button type="primary" :disabled="!$auth('system:dict-item:create')" @click="openMenuModal({})">
          新增
        </a-button>
      </template>
    </DynamicTable>
...
<script lang="ts" setup>
  ...
  import { baseColumns, searchFormSchemas, type TableListItem, type TableColumnItem } from './columns'
