<script setup lang="ts">
  ...
  const deptTree = computed(() => {
    return filterDeptByKeyword(cloneDeep(originDeptTree.value), searchValue.value) as unknown as DataNode[]
  })
  ...
  const fetchDeptList = async () => {
    spinning.value = true
    originDeptTree.value = await Api.systemDept.deptList({}).finally(() => (spinning.value = false))
