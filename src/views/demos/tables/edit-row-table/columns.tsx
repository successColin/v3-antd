...
import { fetchStatusMapData, getClothesByGender, tableData } from '@/views/demos/tables/search-table/columns'
    ...
    formItemProps: {
      ...
      componentProps: ({ formInstance, schema }) => ({
        ...
        onSearch: debounce(async (keyword) => {
          ...
          const result = await fetchStatusMapData(keyword).finally(() => (schema.value.loading = false))
