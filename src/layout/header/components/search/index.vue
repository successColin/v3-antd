<template>
  <Tooltip title="搜索" placement="bottom" :mouse-enter-delay="0.5">
    <slot><SearchOutlined class="colorfff" @click="visible = true" /></slot>
    <DraggableModal v-model:open="visible" title="搜索菜单" :keyboard="false" @cancel="handleClose">
      <a-input ref="inputRef" v-model:value="keyword" clearable placeholder="请输入关键词搜索" @change="handleSearch">
        <template #prefix>
